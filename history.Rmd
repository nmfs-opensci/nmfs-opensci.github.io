...
* Completed establishment of the NMFS GitHub Enterprise account as a secure controlled-access development environment 
* Expanded NMFS Openscapes team training broadly across NOAA Fisheries and include delivery of a Data Science course (similar to the Bureau of Labor Statistics DS academy)
* Completed a scoping document on barriers staff face in accessing or using NOAA, NOAA Fisheries and co-manager data and climate data (cloud and on-premise)
* Catalyzed establishment of more user groups similar to the NMFS R User Group (RUG): NMFS Python User Group (PUG)
* Worked with Microsoft Azure to pilot a JupyterHub/RStudio environment provisioned to work with earth science data in the cloud for NMFS staff similar to that being tested by NASA
* Piloted participation in the University of Washington eScience OceanHack week to both help NMFS staff learn to use diverse oceanographic and fisheries data sets and to support skill-building for underrepresented groups in ocean sciences.
* Continue supporting products created as part of 2022 focus areas

### 2024

* GitHub Enterprise rolled out across NMFS and GitHub Governance Team established (lead by K. Doering) and working together with representatives at each of the science centers and regional offices.
* JupyterHub set up on Azure via a NOAA CRADA and 12 one-hour hackdays for NMFS staff. Ran a 3-hour workshop at NOAA EDMW workshop on accessing NASA earth data in the cloud.
* Expanded use of GitHub Codespaces to more teams via GitHub Enterprise and OST funding (C. Stawitz and K. Doering); developing more expertise in setting up virtual environments and more devcontainer templates.
* E. Holmes participated as organizer in the OceanHackWeek, NASA PACE Hackweek, and NASA Earth Data HackWeek to both learn to use diverse oceanographic and fisheries data sets in prep for running NOAA Fisheries HackWeeks.
* Spring and Summer-Fall GitHub training series run by NMFS Open Science community (led by E. Perl and taught by members of the community).
* 3-year contract awarded to Openscapes to run Champions program, mentors program, and data science school.
* JupyterHub for workshops and collaboration rolled out.
